...
LIST Characters = GABRIEL_SAND, CHEF_MILLER, CHEF_MILLER_NO_CIGAR, AGENT_LUCAS, AGENT_MOORE, ENQUETEUR_BEAULIEU, BRIGHTON, BONNIE_RANDLE_V1, BONNIE_RANDLE_V2, TEACHER_V1, LEIGH_KANE, CHRISTOPHER_YOUNG, NARRATEUR, HOMME, JOHN_RANDLE, VIVIAN, RONNY, TOM, RECEPTIONISTE, OLIVIA_PAUL, CARL_WHITE, MERE_DE_LEIGH_KANE, PERE_DE_LEIGH_KANE, MEDECIN, AL, INTERVENANT, ADMINISTRATEUR, TEACHER_V2, BORIS, JONATHAN, CHRISTIAN, TREVOR, BRAD, ANDREA, JEN, STYLISTE, PALVID, OPULENCE, UPPER_STREAMER, MR_GHOST, CLEAR_VIEW, JUGE_ABBOTT, PREMIER_MINISTRE
