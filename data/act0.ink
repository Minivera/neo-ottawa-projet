=== prologue ===
= tutoriel
<center>Bienvenue dans le monde de RESET 2047. Cette histoire est racontée sous la forme d'une histoire interactive où vos choix décideront du futur.<br/><br/>Pour évoluer dans cette histoire, cliquez sur le bouton "continuer" en bas des fenêtre de dialogue ou appuyez sur la barre espace. Vous pouvez également cliquer n'importe où, ou utiliser la barre d'espace pour accélérer les animations.<br/><br/>Si jamais vous manquez une boite de dialogue ou que vous voulez vous rafraichir la mémoire, une des options dans le menu de droite contient un historique des dernières interactions. Vous pouvez l'ouvrir maintenant pour voir ce texte en entier!</center> # transition
...
<center>Bonne chance, l'avenir des jeux vidéo est entre vos mains.</center> # transition
